...
//        print(item)
    ...
    fileprivate func setupPopupSettings() {
        ...
        nameLabel.anchor(top: topAnchor, left: iconImageView.rightAnchor, bottom: collectionView.topAnchor, right: rightAnchor, paddingTop: 10, paddingLeft: 0, paddingBottom: 10, paddingRight: 0, width: 0, height: 40)
//        nameLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor).isActive = true
        
        collectionView.anchor(top: iconImageView.bottomAnchor, left: iconImageView.rightAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
    }
}
